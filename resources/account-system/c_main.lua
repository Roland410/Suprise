...
blackMales = {14, 16, 17, 18, 20, 21, 22, 24, 25, 28, 35, 36, 51, 66, 67, 78, 79, 80, 83, 84, 134, 136, 156, 163, 166, 168, 176,  182, 183, 185, 220, 221, 222, 249, 253, 260, 262 }
whiteMales = {23, 26, 29, 30, 32, 33, 34, 35, 37, 38, 43, 44, 45, 51, 52, 53, 59, 60, 61, 62, 68, 70, 72, 73, 78, 81, 82, 94, 95, 96, 97, 99, 100, 101, 108, 109, 110, 111, 112, 113, 114, 115, 116, 120, 121, 122, 126, 127, 128, 132, 133, 135, 137, 146, 147, 153, 154, 155, 158, 159, 160, 161, 162, 164, 165, 170, 171, 173, 174, 175, 177, 179, 181, 184, 186, 187, 188, 189, 200, 202, 204, 206, 209, 212, 213, 217, 223, 230, 234, 235, 236, 240, 241, 242, 247, 248, 250, 252, 254, 255, 258, 259, 261, 264, 272 }
asianMales = {49, 57, 58, 59, 60, 170, 186, 187, 203, 210, 227, 228, 229}
blackFemales = {11, 12, 13, 40, 41, 63, 64, 69, 76, 91, 139, 148, 190, 195, 207, 215, 218, 219, 238, 243, 244, 245, 256, 304 }
...
function stopNameChange(oldNick, newNick)
	if (source==getLocalPlayer()) then
		...
		if (oldNick~=newNick) and (legitNameChange==0) then
			...
			outputChatBox("Kattints a 'Karakterválasztás'ra ha a játékbeli identitásodat akarod módosítani.", 255, 0, 0)
		end
	end
end
