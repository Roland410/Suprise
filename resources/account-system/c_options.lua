...
function options_showmenu()
	...
	wOptions = guiCreateWindow(left, top, windowWidth, windowHeight, "Beállítások", false)
	...
	bGraphicsSettings = guiCreateButton(10, 65, 231, 23, "Játékbeállítások", false, wOptions)
	...
	bClose = guiCreateButton(10, 100, 231, 23, "Bezárás", false, wOptions)
...
function options_opengraphicsmenu()
	...
	wGraphicsMenu = guiCreateWindow(left, top, windowWidth, windowHeight, "Játékbeállítások", false)
	guiWindowSetSizable(wGraphicsMenu, false)
	
	cMotionBlur = guiCreateCheckBox(10, 25, 290, 17, "Elmosás engedélyezése", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cMotionBlur, options_updateGameConfig)
	
	cSkyClouds = guiCreateCheckBox(10, 45, 290, 17, "Felhők engedélyezése", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cSkyClouds, options_updateGameConfig)
	
	cStreamingAudio = guiCreateCheckBox(10, 65, 290, 17, "Hangok streamelése", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cStreamingAudio, options_updateGameConfig)
	
	lVehicleStreamer = guiCreateCheckBox ( 10, 95, 290, 17, "Jármű betöltés: Kikapcsolva", false, false, wGraphicsMenu )
	...
	lPickupStreamer = guiCreateCheckBox ( 10, 125, 290, 17, "Interior betöltés: Kikapcsolva", false, false, wGraphicsMenu )
	...
	cLogsEnabled = guiCreateCheckBox(10, 160, 290, 17, "Chat logolása", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cLogsEnabled, options_updateGameConfig)
	
	cBubblesEnabled = guiCreateCheckBox(10, 180, 290, 17, "Chat ikon engedélyezése", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cBubblesEnabled, options_updateGameConfig)
	
	cIconsEnabled = guiCreateCheckBox(10, 200, 290, 17, "Írás ikon engedélyezése", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cIconsEnabled, options_updateGameConfig)
	
	cEnableNametags = guiCreateCheckBox(10, 220, 290, 17, "Nevek mutatása", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cEnableNametags, options_updateGameConfig)
	
	cEnableRShaders = guiCreateCheckBox(10, 240, 290, 17, "Radar árnyékolása", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cEnableRShaders, options_updateGameConfig)
	
	cEnableWShaders = guiCreateCheckBox(10, 260, 290, 17, "Víz árnyékolása", false, false, wGraphicsMenu)
	addEventHandler("onClientGUIClick", cEnableWShaders, options_updateGameConfig)
	
	bGraphicsMenuClose = guiCreateButton(10, 285, 290, 23, "Bezárás", false, wGraphicsMenu)
...
function options_logOut( message )
	triggerServerEvent("accounts:characters:change", getLocalPlayer(), "Karakterválasztás")
