...
drawBackground = function ()
	...
	if g_currentHeight > SCOREBOARD_HEADER_HEIGHT then
		-- Draw the image
		dxDrawImage ( SCOREBOARD_X * 1, SCOREBOARD_Y * 1.1 + SCOREBOARD_HEADER_HEIGHT,
					  g_currentWidth / 1, g_currentHeight / 1 - SCOREBOARD_HEADER_HEIGHT,
...
drawScoreboard = function ()
	...
	local serverName = getElementData ( g_scoreboardDummy, "serverName" ) or "[SeeLife]-FlyMta Roleplay!"
	...
	local strPlayerCount = "Játékosok: " .. tostring(#g_players) .. "/" .. tostring(maxPlayers) .. " (" .. math.floor(usagePercent + 0.5) .. "%)"
