...
addEventHandler( "admin:stats", localPlayer,
	function( results )
		...
		local colName = guiGridListAddColumn( gStats, "Név", 0.43 )
		local colTime = guiGridListAddColumn( gStats, "Report", 0.23 )
		local colOnline = guiGridListAddColumn( gStats, "Utoljára online", 0.5 )
		...
		bClose = guiCreateButton( 0.03, 0.93, 0.94, 0.07, "Bezár", true, wStats )
