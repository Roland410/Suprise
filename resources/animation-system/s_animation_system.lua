...
addCommandHandler("gugol", coverAnimation, false, false)
...
addCommandHandler("ujraéleszt", cprAnimation, false, false)
...
addCommandHandler("gyere", copcomeAnimation, false, false)
...
addCommandHandler("állj", copstopAnimation, false, false)
...
addCommandHandler ( "várni", pedWait, false, false )
...
addCommandHandler ( "kézölbe", pedThink, false, false )
...
addCommandHandler ( "kézzseb", pedShake, false, false )
...
addCommandHandler ( "hátradöl", pedLean, false, false )
...
addCommandHandler("felsziv", idleAnimation, false, false)
...
addCommandHandler ( "pisil", pedPiss, false, false )
...
addCommandHandler ( "hoki", pedWank, false, false )
...
addCommandHandler ( "segre", pedSlapAss, false, false )
...
addCommandHandler ( "szerel", pedCarFix, false, false )
...
addCommandHandler ( "kézfel", pedHandsup, false, false )
...
addCommandHandler ("taxi", pedTaxiHail, false, false )
...
addCommandHandler ( "here", pedScratch, false, false )
...
addCommandHandler ( "sztriptiz", pedStrip, false, false )
...
addCommandHandler ( "intés", pedHeil, false, false )
...
addCommandHandler ( "ivás", pedDrink, false, false )
...
addCommandHandler ( "hanyattfekvés", pedLay, false, false )
...
addCommandHandler ( "félelem", begAnimation, false, false )
...
addCommandHandler ( "részvét", pedMourn, false, false )
...
addCommandHandler ( "sirás", pedCry, false, false )
...
addCommandHandler ( "betépve", pedCheer, false, false )
...
addCommandHandler ( "tánc", danceAnimation, false, false )
...
addCommandHandler ( "epilepszia", crackAnimation, false, false )
...
addCommandHandler("hányás", pukeAnimation, false, false)
...
addCommandHandler("leül", sitAnimation, false, false)
...
addCommandHandler("cigi", smokeAnimation, false, false)
...
addCommandHandler("hátradölcigi", smokeleanAnimation, false, false)
...
addCommandHandler("evés", smokedragAnimation, false, false)
...
addCommandHandler("nevet", laughAnimation, false, false)
...
addCommandHandler("indit", startraceAnimation, false, false)
...
addCommandHandler("fáradt", tiredAnimation, false, false)
...
addCommandHandler("ölelés", handshakeAnimation, false, false)
...
addCommandHandler ( "mivan", whatAnimation, false, false )
...
addCommandHandler ( "fekvés", fallAnimation, false, false )
...
addCommandHandler("séta", walkAnimation, false, false)
