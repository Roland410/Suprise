...
function createATM(thePlayer, commandName)
	--if (exports.global:isPlayerLeadAdmin(thePlayer)) and ( getElementDimension(thePlayer) > 0 or exports.global:isPlayerScripter(thePlayer)
if (exports.global:isPlayerScripterAdmin(thePlayer) ) then
		...
		outputChatBox("wasd", thePlayer, 255, 0, 0)
	end
end
