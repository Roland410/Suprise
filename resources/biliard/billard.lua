...
local tables={ 	-- define table positions here
  -- x,y,z, dimension, interior
	{ 1212,-1422,13.38, 0,0}, -- two tables at grove street
	{ 1226,-1422,13.37, 0,0},
	{ 1130.1894,-2.5351,1000.6796, 297,12},
...
addCommandHandler("resettable",function(plr,cmd,tn)
	...
	if not tn then
		outputChatBox("Use: /felpakol <asztal szám>", plr)
		return
	end
...
--[[
	...
	createBalls(tn)
	triggerEvent("broadcastCaptionedEvent", plr, getPlayerName(plr) .. " Ujra felpakoltuk az asztalt.", 5, 5, true)
end)                                                                   