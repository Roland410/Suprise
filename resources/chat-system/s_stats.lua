function showStats(thePlayer, commandName, targetPlayerName)
	...
	if exports.global:isPlayerAdmin(thePlayer) and targetPlayerName then
		...
		if targetPlayer then
			if getElementData(targetPlayer, "loggedin") == 1 then
				...
				outputChatBox("Nem vagy bejelentkezve!", showPlayer, 255, 0, 0)
				return
			end
		else
			return
	...
	outputChatBox("Jogosítvány: " .. carlicense, showPlayer, 255, 194, 14)
	outputChatBox("Fegyverengedély: " .. gunlicense, showPlayer, 255, 194, 14)
	outputChatBox("Járművek (" .. numcars .. "): " .. string.sub(carids, 1, string.len(carids)-2), showPlayer, 255, 194, 14)
	outputChatBox("Ingatlanok (" .. numproperties .. "): " .. string.sub(properties, 1, string.len(properties)-2), showPlayer, 255, 194, 14)
	outputChatBox("Játszott idő(karakter): " .. hoursplayed .. " óra.", showPlayer, 255, 194, 14)
	outputChatBox("Nyelvek: " .. table.concat(languages, ", "), showPlayer, 255, 194, 14)
	outputChatBox( "Pénz: " .. exports.global:formatMoney( exports.global:getMoney( thePlayer ) .." Ft" ), showPlayer, 255, 194, 14)
	outputChatBox("~-~-~-~-~-~-~-~-~-~-~-~-~-~-~~-~", showPlayer, 255, 194, 14)
end
addCommandHandler("stats", showStats, false, false)

function showMoney( thePlayer )
	outputChatBox( "Pénz: " .. exports.global:formatMoney( exports.global:getMoney( thePlayer ) .." Ft" ), thePlayer )
end
