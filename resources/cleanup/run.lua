function doCleanUp(thePlayer)
	...
	-- Show some stats
	outputChatBox("El lett adva(/sellpropertied) "..count1.." interior", thePlayer)
	outputChatBox("Ki lett törölve "..count2.." lefoglalt jármű", thePlayer)		
	outputChatBox("Ki lett törölve "..count3.." használatlan jármű", thePlayer)		
end
...
function doItemCleanUp(thePlayer)
	...
	-- Show some stats
	outputChatBox("Ki lett törölve "..count1.." item a tulajdonos nélküli ingatlanok széfjéből.", thePlayer)
	outputChatBox("Ki lett törölve "..count2.." item be nem zárt ingatlanokból", thePlayer)			
	outputChatBox("Ki lett törölve "..count3.." item a be nem zárt járművekből", thePlayer)			
