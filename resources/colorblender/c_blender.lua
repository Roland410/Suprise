...
function colorPicker.create(id, start, title)
  ...
  cp.gui.window = guiCreateWindow((sw-cp.gui.width)/2, (sh-cp.gui.height)/2, cp.gui.width, cp.gui.height, tostring(title or "Színkeverés"), false)
  ...
  cp.gui.okb = guiCreateButton(336, 235, 64, 24, "Rendben", false, cp.gui.window)
  cp.gui.closeb = guiCreateButton(336, 265, 64, 24, "Mégse", false, cp.gui.window)
  cp.gui.focus = true
