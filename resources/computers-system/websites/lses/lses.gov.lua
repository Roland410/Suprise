...
function www_mento_hu()
	...
	guiSetText(address_bar,"www.mento.hu") -- The url of the page. This should be the same as the function name but with the original "."s and "/". Example www.google.com.
	...
	local header_1 = guiCreateLabel(131,70,200,16,"Üdvözlünk",false,bg)
	local para1 = guiCreateLabel(128,94,329,70,"Üdv az országos mentőszolgálat hivatalos honalpján! ",false,bg) 
	...
	local header_2 = guiCreateLabel(131,170,200,16,"Kik vagyunk és mit csínálunk?",false,bg)
	local para2 = guiCreateLabel(128,194,329,70,"Mi egy csapat vagyunk akiknek az egészséges élet és a biztonság a cél! ",false,bg) 
	...
	local header_3 = guiCreateLabel(131,270,200,16,"Hol vagyunk?",false,bg)
	local para3 = guiCreateLabel(128,294,329,70,"Megtalálsz minket LS-ben és LV-ben is a kórházban! ",false,bg) 
