...
function www_mento_hu_join()
	...
	guiSetText(address_bar,"www.mento.hu/Join") -- The url of the page. This should be the same as the function name but with the original "."s and "/". Example www.google.com.
	...
	local header_1 = guiCreateLabel(131,70,200,16,"Ki csatlakozhat hozzánk?",false,bg)
	local para1 = guiCreateLabel(128,94,329,70,"Mi mindig keresünk új tagokat, mentősöket, ápolókat, műtősöket a lényeg hogy szakképzett légy és szeresd a munkád! ",false,bg) 
	...
	local header_2 = guiCreateLabel(131,170,200,16,"Mi kell hogy csatlakozz?",false,bg)
	local para2 = guiCreateLabel(128,194,329,70,"Egy PDA amin keresztül elküldöd az önéletrajzod E-mail-en keresztül. ",false,bg) 
	...
	local header_3 = guiCreateLabel(131,270,200,16,"Mikor kerülsz be?",false,bg)
	local para3 = guiCreateLabel(128,294,329,70,"Miután elbírálták a jelentkezésed, egy próba szintre lépsz ahul beletanulsz jövőbeli munkádba.",false,bg) 
