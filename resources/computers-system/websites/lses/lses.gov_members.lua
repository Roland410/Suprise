...
function www_mento_hu_members()
	...
	guiSetText(address_bar,"www.mento.hu/Members") -- The url of the page. This should be the same as the function name but with the original "."s and "/". Example www.google.com.
	...
	local header_1 = guiCreateLabel(131,70,200,16,"Vezető",false,bg)
	local para1 = guiCreateLabel(128,94,329,70,"A vezető egyben az igazgatő, ő bírálja el a jelentkezést és értelemszerűen ő irányít! ",false,bg) 
	...
	local header_2 = guiCreateLabel(131,170,200,16,"Vezető helyettes",false,bg)
	local para2 = guiCreateLabel(128,194,329,70,"Ő a vezető jobb keze, ha a főnök nem ér rá ő irányít!  ",false,bg) 
	...
	local header_3 = guiCreateLabel(131,270,200,16,"További tagok",false,bg)
	local para3 = guiCreateLabel(128,294,329,70,"Képzettség szerinti beosztás van jelen a további tagok között! ",false,bg) 
