...
table.insert(policeColShapes, createDutyColShape(1803.3291, -1531.7158, 5700.46875, 3, 10, 1) ) -- PD Pershing square
...
local lsesColShapes = { }
table.insert(lsesColShapes, createDutyColShape( 1653.1927, 1805.1328, 511.8143, 5, 1, 161) ) -- LS Hospital Duty room
table.insert(lsesColShapes, createDutyColShape( 1165.6962, -1316.7490, 13.5687, 6, 1, 2279) ) -- EMS County general room

local lsfdColShapes = { }
table.insert(lsfdColShapes, createDutyColShape( 354.8349, 188.4335, 1008.3797, 6, 3, 10631) ) -- LSFD duty room
...
local hexColShapes = { }
table.insert(hexColShapes, createDutyColShape(344.0439, -1838.5771, 4.6706, 15, 1, 1472) ) -- Hex weapon room

local katonaColShapes = { }
table.insert(katonaColShapes, createDutyColShape(297.4208984375, 186.0048828125, 1007.171875, 15, 1, 1472) ) -- Hex weapon room


local nav = { }
table.insert(nav, createDutyColShape(236.3251, 110.5908, 1003.2257, 6, 1, 1472) ) -- nav
...
factionDuty = {
	{ 
		...
		packages = {
			{
				packageName = 'LSPD - Magasszintű felszerelés',
				grantID = 1,
				forceSkinChange = true,
				skins = { 211, 265, 266, 267, 280, 281, 282},
			...
			{
				packageName = 'LSPD - SWAT Felszerelés',
				grantID = 2,
				forceSkinChange = true,
				skins = { 285 },
				colShape = policeColShapes,
			...
			{
				packageName = 'LSPD - Detektív felszerelés',
				grantID = 3,
			...
			{
				packageName = 'LSPD - Kadét felszerelés',
				grantID = 4,
				forceSkinChange = true,
				skins = { 71, 211 },
				colShape = policeColShapes,
		...
		packages = {
			{
				...
				grantID = 12,
				forceSkinChange = true,
				colShape = katonaColShapes,
				skins = { 287},
				items =	{
					--{ -30, 200, false }, -- Spraycan/Pepperspray
					{ -100, 49, false }, -- Kevlar
					{ -4, 1,  false }, -- knife
					{ -46, 1,  false } -- Parachute
				}
			}, 		
		}
	},
