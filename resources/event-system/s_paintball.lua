...
function onPaintballHit(thePlayer)
	...
	if (paintball) and not (playersHit[thePlayer]) then
		...
		local marker1 = createMarker ( 1310.1650, -1375.8652, 13.6471, "corona", 5.5, r, g, b, 255 )
...
addEvent("paintball", true)
addEventHandler( "paintball", getRootElement(), onPaintballHit)
