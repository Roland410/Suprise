...
{
    {
		{ createObject ( 1495, 1811.77368, -1545.81897, 5699.36475, 0.00000, 0.00000, 180.00000 ),90 },
		{ createObject ( 1495, 1808.77576, -1545.81897, 5699.36475 ), -90 }
	},
...
for _, group in pairs(pdgates) do
	for _, gate in ipairs(group) do
		...
		setElementDimension(gate[1], 4)--10583
	end
end
...
local function openDoor(thePlayer)
	if getElementDimension(thePlayer) == 4 and getElementInterior(thePlayer) == 15 and exports.global:hasItem(thePlayer, 64) then
