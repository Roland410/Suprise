...
function usePDSideGarageGate(thePlayer)
	...
	if (distance1<=10) and (open==false) then
		if (exports.global:hasItem(thePlayer, 64) or exports.global:hasItem(thePlayer, 64)) then
			open = true
			which = 1
	...
	elseif (distance2<=10) and (open==false) then
		if (exports.global:hasItem(thePlayer, 87)) then
			open = true
			which = 2
			outputChatBox("LSPD Sorompó nyitva!", thePlayer, 0, 255, 0)
...
addCommandHandler("nyit", usePDSideGarageGate)
