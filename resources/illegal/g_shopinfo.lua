...
--			{ name = "Phonebook", description = "A large phonebook of everyones phone numbers.", price = 30, itemID = 7 },
	...
	{ -- 12
		...
		
		{
			...
			{ name = "m4 tölténycsomag", description = "m4 1000 golyo.", price = 0, itemID = 116, itemValue = 31, ammo = 1000, license = true },
			{ name = "ak47", description = "ak47.", price = 0, itemID = 115, itemValue = 30, license = true },
			{ name = "ak47 tölténycsomag", description = "ak47 1000 golyo.", price = 0, itemID = 116, itemValue = 30, ammo = 1000, license = true },
			{ name = "tec9", description = "tec9.", price = 0, itemID = 115, itemValue = 32, license = true },
			{ name = "tec9 tölténycsomag", description = "tec9 1000 golyo.", price = 0, itemID = 116, itemValue = 32, ammo = 1000, license = true },
			{ name = "mp5", description = "mp5.", price = 0, itemID = 115, itemValue = 29, license = true },
			{ name = "mp5 tölténycsomag", description = "mp5 1000 golyo.", price = 0, itemID = 116, itemValue = 29, ammo = 1000, license = true },
	...
	{ -- 15
		...
		{
			name  = "Börtönőr",
			{ name = "Tálca kaja", description = "Tálca kaja.", price = 2000, itemID = 99 },
			{ name = "Üveges tej", description = "kenyér mellé jól jön!", price = 2000, itemID = 100 },
			{ name = "Narancs üditő", description = "narancs üditő", price = 2000, itemID = 101 },
		}
	}
}
