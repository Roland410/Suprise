...
function canEnterInterior(theInterior)
	...
	if interiorID then
		...
		if interiorStatus[INTERIOR_DISABLED] then
			return false, 1, "Ez az interior jelenleg ki van kapcsolva."
		elseif interiorStatus[INTERIOR_LOCKED] then
			return false, 2, "Megpróbáltad lenyomni a kilincset, de az ajtó zárva van."
		end
		return true
	end
	return false, 3, "Script hiba(intsys/g_shar".. interiorID ..") 100.4"
end
