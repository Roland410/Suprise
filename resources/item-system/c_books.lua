...
function createBook( bookName, bookTitle )
	...
	if not (wBook) then
		...
		buttonPrev = guiCreateButton( 0.85, 0.25, 0.14, 0.05, "Előző", true, wBook)
		addEventHandler( "onClientGUIClick", buttonPrev, prevButtonClick, false )
		guiSetVisible(buttonPrev, false)

		buttonClose = guiCreateButton( 0.85, 0.45, 0.14, 0.05, "Bezárás", true, wBook)
		addEventHandler( "onClientGUIClick", buttonClose, closeButtonClick, false )
		
		buttonNext = guiCreateButton( 0.85, 0.65, 0.14, 0.05, "Következő", true, wBook)
