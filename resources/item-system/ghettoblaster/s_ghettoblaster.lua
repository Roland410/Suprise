...
function toggleGhettoblaster(item)
	...
	if state > 0 then
		exports.global:sendLocalMeAction(source, "kikapcsolta a magnót.")
	else
		exports.global:sendLocalMeAction(source, "bekapcsolta a magót.")
	end
...
function changeTrack(item, step)
	...
	if current > 0 then
		...
		exports.global:sendLocalMeAction(source, "zenét váltott.")
	end
end
