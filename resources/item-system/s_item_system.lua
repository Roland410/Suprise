...
function useItem(itemSlot, additional)
	...
	if itemID then
		if (itemID==1) then -- hotdog
			...
			exports.global:sendLocalMeAction(source, "eszik egy hotdogot.")
		...
		elseif (itemID==8) then -- sandwich
			...
			exports.global:sendLocalMeAction(source, "eszik egy szendvicset.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==9) then -- sprunk
			...
			toggleAllControls(source, true, true, true)
			triggerClientEvent(source, "onClientPlayerWeaponCheck", source)
			exports.global:sendLocalMeAction(source, "iszik egy sprunkot.")
			takeItemFromSlot(source, itemSlot)
		...
		elseif (itemID==11) then -- taco
			...
			exports.global:applyAnimation(source, "FOOD", "EAT_Burger", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "eszik egy tacot.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==12) then -- cheeseburger
			giveHealth(source, 10)
			exports.global:applyAnimation(source, "FOOD", "EAT_Burger", 4000, false, true, true)
			setTimer(removeAnimation, 4000, 1, source)
			exports.global:sendLocalMeAction(source, "eszik egy sajtburgert.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==13) then -- donut
			setElementHealth(source, 100)
			exports.global:applyAnimation(source, "FOOD", "EAT_Burger", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "eszik egy fánkot.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==14) then -- cookie
			giveHealth(source, 80)
			exports.global:applyAnimation(source, "FOOD", "EAT_Burger", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "eszik egy sütit.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==15) then -- water
			giveHealth(source, 90)
			exports.global:applyAnimation(source, "VENDING", "VEND_Drink_P", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "iszik egy pohár ásványvizet.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==16) then -- clothes
			...
			if fittingskins[gender] and fittingskins[gender][race] and fittingskins[gender][race][skin] then
				...
				exports.global:sendLocalMeAction(source, "átöltözik.")
				if vehicle then
		...
		elseif (itemID==17) then -- watch
			exports.global:sendLocalMeAction(source, "ránéz az órájára.")
			outputChatBox("Pontos idő: " .. string.format("%02d:%02d", getTime()) .. ".", source, 255, 194, 14)
		...
		elseif (itemID==27) then -- FLASHBANG
			...
			exports.global:sendLocalMeAction(source, "eldob egy vakítógránátot.")
		...
		elseif (itemID==28) then -- GLOWSTICK
			...
			exports.global:sendLocalMeAction(source, "eldob egy világító rudat.")
		...
		elseif (itemID==50) then -- highway code book
			local bookTitle = "Los Santos Közlekedési Kézikönyv"
			local bookName = "LSHighwayCode"
			exports.global:sendLocalMeAction(source, "elolvassa: ".. bookTitle ..".")
			triggerClientEvent( source, "showBook", source, bookName, bookTitle )
		elseif (itemID==51) then -- chemistry book
			local bookTitle = "Kémia 101"
			local bookName = "Kémia101"
			exports.global:sendLocalMeAction(source, "elolvassa: ".. bookTitle ..".")
			triggerClientEvent( source, "showBook", source, bookName, bookTitle )
		elseif (itemID==52) then -- PD manual book
			local bookTitle = "Rendőr kézikönyv"
			local bookName = "PDmanual"
			exports.global:sendLocalMeAction(source, "elolvassa: ".. bookTitle ..".")
			triggerClientEvent( source, "showBook", source, bookName, bookTitle )
		elseif (itemID==54) then -- GHETTOBLASTER
			exports.global:sendLocalMeAction(source, "leteszi a földre a Ghettoblaster márkájú magnóját.")
		...
		elseif (itemID==58) then
			takeItemFromSlot(source, itemSlot)
			exports.global:sendLocalMeAction(source, "iszik egy kis Ziebrand sört.")
		...
		elseif (itemID==60) then
			...
			if (retval == 0) then
				exports.global:sendLocalMeAction(source, "lerak egy széfet.")
				takeItemFromSlot(source, itemSlot)
		...
		elseif (itemID==62) then
			takeItemFromSlot(source, itemSlot)
			exports.global:sendLocalMeAction(source, "iszik egy kis Bastradov vodkát.")
			setElementHealth(source,getElementHealth(source)-10)
		elseif (itemID==63) then
			takeItemFromSlot(source, itemSlot)
			exports.global:sendLocalMeAction(source, "iszik egy kis Skót Whiskey-t.")
			setElementHealth(source,getElementHealth(source)-10)
		elseif (itemID==69) then -- Dictionary
			...
			if (learned) then
				...
				outputChatBox("Megtanultad alap szinten az " .. lang .. " nyelvet, nyomj F6-ot a nyelvek kezeléséhez.", source, 0, 255, 0)
			end
		elseif (itemID==72) then -- Note
			exports.global:sendLocalMeAction(source, "jegyzetet ír.")
		...
		elseif (itemID==77) then -- Card Deck
			local cards = { "Ász", "Kettes", "Hármas", "Négyes", "Ötös", "Hatos", "Hetes", "Nyolcas", "Kilences", "Tizes", "Bubi", "Dáma", "Király" }
			local sign = { "Pikk", "Treff", "Kőr", "Káró" }
			local number = math.random( 1, #cards )
			local snumber = math.random( 1, #sign )
			exports.global:sendLocalText(source, " *((Kártyák)) " .. getPlayerName(source):gsub("_", " ") .. " lerak egy kártyát: " .. ( number == 1 and "n" or "" ) .. " " .. sign[snumber] .." ".. cards[number] ..".", 255, 51, 102)
		...
		elseif (itemID==83) then -- Coffee
			...
			exports.global:applyAnimation(source, "VENDING", "VEND_Drink_P", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "iszik egy csésze kávét.")
			takeItemFromSlot(source, itemSlot)
		...
		elseif (itemID==91) then
			takeItemFromSlot(source, itemSlot)
			exports.global:sendLocalMeAction(source, "iszik egy kis tojáslikőrt.")
			setElementHealth(source, 100)
		...
		elseif (itemID==93) then
			setElementHealth(source, 100)
			exports.global:applyAnimation(source, "FOOD", "EAT_Burger", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "eszik egy karácsonyi pudingot.")
			takeItemFromSlot(source, itemSlot)
		...
		elseif (itemID==96) then -- PDA
			exports.global:sendLocalMeAction(source, "bekapcsolja a " .. ( itemValue == 1 and "PDA" or itemValue ) .. "-ját.")
			triggerClientEvent(source, "useCompItem", source)
		elseif (itemID==97) then -- LSES Procedures Manual (book)
			local bookTitle = "LSES útmutató"
			local bookName = "LSESútmutató"
			exports.global:sendLocalMeAction(source, "elolvassa: ".. bookTitle ..".")
			triggerClientEvent( source, "showBook", source, bookName, bookTitle )
		...
		elseif (itemID==99) then --[ADDED: 2/22/10 by herbjr] tray
			...
			toggleAllControls(source, true, true, true)
			triggerClientEvent(source, "onClientPlayerWeaponCheck", source)
			exports.global:sendLocalMeAction(source, "eszik egy tálcáról.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==100) then --[ADDED: 2/22/10 by herbjr] milk
			...
			toggleAllControls(source, true, true, true)
			triggerClientEvent(source, "onClientPlayerWeaponCheck", source)
			exports.global:sendLocalMeAction(source, "iszik egy kis doboz tejet.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==101) then --[ADDED: 2/22/10 by herbjr] juice
			...
			toggleAllControls(source, true, true, true)
			triggerClientEvent(source, "onClientPlayerWeaponCheck", source)
			exports.global:sendLocalMeAction(source, "iszik egy kis doboz juice-t.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==102) then --[ADDED: 2/23/10 by herbjr] Cabbage (Asked for by Misha)
			...
			toggleAllControls(source, true, true, true)
			triggerClientEvent(source, "onClientPlayerWeaponCheck", source)
			exports.global:sendLocalMeAction(source, "eszik egy fej káposztát.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==104) then -- portable TV
			...
			if isTvUsed == nil or isTvUsed == false then
				exports.global:sendLocalMeAction(source, "bekapcsolja a hordozható TVjét.")
		...
		elseif (itemID == 105) then -- Pack of cigarettes. Withdraw one if it still has one
			if (itemValue > 0) then
				if (hasSpaceForItem(source, 106, 1)) then
					...
					exports.global:sendLocalMeAction(source, "előveszi a cigisdobozát és kivesz belőle egy szálat.")
				else
					outputChatBox( "Az inventoryd tele van.", source, 255, 0, 0 )
				end
			else
				exports.global:sendLocalMeAction(source, "előveszi a cigisdobozát és belenéz de nem talál benne semmit.")
			end
		elseif (itemID == 106) then -- Cigarette
			if hasItem( source, 107 ) then
				exports.global:sendLocalMeAction(source, "rágyújt.")
				outputChatBox( "(( Eldobáshoz írd be: '/throwaway', kéz váltáshoz: '/switchhand' ))", source )
				triggerEvent("realism:startsmoking", source, 0) -- 0 = left hand -- 1 = right hand
				takeItemFromSlot(source, itemSlot)
			else
				exports.global:sendLocalMeAction(source, "megmutatja a cigit.")
				outputChatBox( "Öngyújtóra van szükséged, hogy rágyújts.", source, 255, 0, 0 )
			end
		...
		elseif (itemID==108) then -- donut
			setElementHealth(source, 100)
			exports.global:applyAnimation(source, "FOOD", "EAT_Burger", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "eszik egy palacsintát.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID==109) or (itemID==110) then -- Fruit
			giveHealth(source, tonumber(getItemValue(itemID, itemValue)))
			exports.global:applyAnimation(source, "food", "eat_burger", 4000, false, true, true)
			exports.global:sendLocalMeAction(source, "eszik egy " .. itemName .. "t.")
			takeItemFromSlot(source, itemSlot)
		elseif (itemID == 113) then -- Pack of glowsticks, Withdraw one if it still has one
			if (itemValue > 0) then
				if (hasSpaceForItem(source, 28, 1)) then
					...
					exports.global:sendLocalMeAction(source, "belenéz a világító rúd dobozába és kivesz egyet.")
				else
					outputChatBox( "Az inventoryd tele van.", source, 255, 0, 0 )
				end
			else
				exports.global:sendLocalMeAction(source, "belenéz a világító rúd dobozába, de nem talál semmit.")
			end
		...
		elseif masks[itemID] then
			...
			elseif getPedOccupiedVehicle(source) and getElementData(getPedOccupiedVehicle(source), "job") > 0 and getVehicleOccupant(getPedOccupiedVehicle(source)) == source then
				outputChatBox("Ezt civil járműben nem használhatod.", source, 255, 0, 0)
			else
			...
			outputChatBox("Sajnálom" .. ("%04d"):format(tonumber(itemID) or 9999) .. "Ezeket csak parancsokkal tudod használni", source, 255, 0, 0)
		end
	end
end
...
function destroyItem(itemID)
	...
	outputChatBox("Megsemmisítettél egy " .. itemName .. "t.", source, 255, 194, 14)
	exports.global:sendLocalText(source, " ** " .. getPlayerName(source):gsub("_", " ") .. " megsemmisített egy " .. itemName .. "t.", 255, 51, 102) 
end
...
function showItem(itemName)
	if isPedDead(source) or getElementData(source, "injuriedanimation") then return end
	exports.global:sendLocalMeAction(source, "megmutatja: " .. itemName .. ".")
end
