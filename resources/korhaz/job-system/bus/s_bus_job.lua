...
function payBusDriver(line, stop)
	...
	if stop == -2 then
		removeDriver()
		exports.global:giveMoney(client, 1800)
	elseif stop == -1 then
...
function busAdNextStop(line, stop)
	...
	exports.global:sendLocalText(source, " -- Megálló: [".. g_bus_routes[line].stops[stop] .. "] --", 255, 51, 102)
	if(stop<#g_bus_routes[line].stops)then
		exports.global:sendLocalText(source, " -- Következő Megálló: [".. g_bus_routes[line].stops[stop+1] .. "] --", 255, 51, 102)
	end
end
...
function takeBusFare(thePlayer)
	exports.global:takeMoney(source, 400)
	exports.global:giveMoney(thePlayer, 400)
end
