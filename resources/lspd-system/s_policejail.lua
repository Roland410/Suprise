...
cells =
{
	createColSphere( 1800.55371, -1553.03809, 5699.65332, 2 ), --1 kicserélve
...
for k, v in pairs( cells ) do
	setElementInterior( v, k <= 4 and 15 or 11 )
	setElementDimension( v, k <= 4 and 1 or 78 )
	if k <= 4 then
...
addCommandHandler("lecsuk", arrestPlayer)
