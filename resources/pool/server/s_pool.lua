...
function showsize(thePlayer)
	...
	outputChatBox("Játékos: " .. tostring(players) .. ":" .. tostring(tplayers), thePlayer)
	outputChatBox("Jármű: " .. tostring(vehicles) .. ":" .. tostring(tvehicles), thePlayer)
	outputChatBox("Colshape-ek: " .. tostring(colshapes) .. ":" .. tostring(tcolshapes), thePlayer)
	outputChatBox("NPC-k: " .. tostring(peds) .. ":" .. tostring(tpeds), thePlayer)
	outputChatBox("3D checkpoint: " .. tostring(markers) .. ":" .. tostring(tmarkers), thePlayer)
	outputChatBox("Objektek: " .. tostring(objects) .. ":" .. tostring(tobjects), thePlayer)
	outputChatBox("Pickupok: " .. tostring(pickups) .. ":" .. tostring(tpickups), thePlayer)
	outputChatBox("Csapatok: " .. tostring(teams) .. ":" .. tostring(tteams), thePlayer)
	outputChatBox("2D térképjelzések: " .. tostring(blips) .. ":" .. tostring(tblips), thePlayer)
