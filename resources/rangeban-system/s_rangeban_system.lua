	...
	function(playerNick, playerIP, playerUsername, playerSerial, playerVersion)
		...
		for _, v in pairs( serials ) do
			if (playerSerial == v) then
				exports.global:sendMessageToAdmins("Figyelem: Bannolt " .. playerIP .. "/"..playerVersion.."/"..playerNick.."/(("..playerSerial..")) Akar feljönni")
				cancelEvent( true, "Sajnálom de bannolva vagy!írj unbann kérelmet fórumon." )
			end
		end
