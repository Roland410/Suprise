...
function showCKInfo(text, name)
	...
	ckInfoWindow = guiCreateWindow(ax, ay, 350, 200, name and ( "A holttest (( " .. name .. " )) " ) or "A holttestet egy halott.", false)
	...
	local cbutton = guiCreateButton(0.05, 0.85, 0.87, 0.1, "Bezár", true, ckInfoWindow)
