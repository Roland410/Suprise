...
function askAcceptFriend()
	...
	bButtonYes = guiCreateButton(0.1,0.65,0.37,0.23,"Igen",true,wConfirmFriendRequest)
	bButtonNo = guiCreateButton(0.53,0.65,0.37,0.23,"Nem",true,wConfirmFriendRequest)
