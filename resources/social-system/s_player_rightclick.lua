...
function restrainPlayer(player, restrainedObj)
	...
	exports.global:sendLocalDoAction(player, "Megbilincseltek Valakit a közelben.")
	outputChatBox("Megbilincselt téged " .. username .. ".", player,0,255,0)
	outputChatBox("Megbilincselted a célszemélyt " .. targetPlayerName .. ".", source,0,255,0)
	attachElements (player, source, 0,-1,0) --Attach the tank to the player.
...
function unrestrainPlayer(player, restrainedObj)
    ...
    exports.global:sendLocalDoAction(player, "Valakiről levették a bilincset a közelben.")
	outputChatBox("Levette Rólad a bilincset " .. username .. ".", player,0,255,0)
	outputChatBox("Levetted Róla a bilincset " .. targetPlayerName .. ".", source,0,255,0)
...
function blindfoldPlayer(player)
	...
	outputChatBox("" .. username .. " bekötötte a szemed.", player)
	outputChatBox("Bekötötted " .. targetPlayerName .. " szemét.", source)
...
function stabilizePlayer(player)
	...
	if found then
		...
		outputChatBox("Nem szorul segitségre " .. username .. ".", player)
		outputChatBox("Te segitettél   " .. targetPlayerName .. ".", source)
