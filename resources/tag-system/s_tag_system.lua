...
function makeTagObject(cx, cy, cz, rot, interior, dimension)
	...
	if (tag~=9) then
		...
		outputChatBox("Sikeresen felvittél egy graffitit!", source, 255, 194, 14)
	else
		local distance = 2
		...
		if (object) then
			...
			outputChatBox("Sikeresen letakaritottad a graffitit,és kerestél 4000 Ft-ot", source, 255, 194, 14)
			exports.global:giveMoney(source, 4000)
